...
def test_schema():
    ...
    post_detail1 = schema["paths"]["/api/descr-union"]["post"]["requestBody"]["content"][
        "application/json"
    ]["schema"]
    post_detail2 = schema["paths"]["/api/regular-union"]["post"]["requestBody"]["content"][
        "application/json"
    ]["schema"]
    get_detail1 = schema["paths"]["/api/descr-union"]["get"]["parameters"][0]["schema"]
    get_detail2 = schema["paths"]["/api/regular-union"]["get"]["parameters"][0]["schema"]
